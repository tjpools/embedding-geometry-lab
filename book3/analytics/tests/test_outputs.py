...
class OutputContractTests(unittest.TestCase):
    def build_book(self, root: Path) -> Path:
        ...
        registry = {
            "schema_version": 1,
            "book": {"name": "Book Three", "analytics_title": "Book Three Analytics"},
            "architecture": {
                "modules": "modules.txt",
    ...
    def test_framing_mode_emits_complete_output_contract(self):
        ...
        self.assertEqual(heatmap_title.text, "Book Three Architecture Density")
    ...
    def test_chapter_draft_switches_report_and_heatmap_mode(self):
        ...
        self.assertEqual(heatmap_title.text, "Book Three Chapter Analytics")
