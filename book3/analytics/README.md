...
This directory is Book Three's self-inspection layer. A standard-library Python engine measures the current corpus and emits human-readable, machine-readable, and visual artifacts.
...
- `analyze.py` is the stable public command.
...
- **Vocabulary:** unique-word ratio and selected philosophical-term density per 1,000 words
...
- **Visual density:** a mode-aware, column-normalized heatmap using the inherited analytic palette
