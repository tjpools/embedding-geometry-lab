...
```mermaid
flowchart TD
    A[Me<br/>trained human prior] -->|J₁: Human-to-Model Jacobian| B[You<br/>trained model prior]
    B -->|J₂: Coupling Jacobian| C[Us<br/>trained posterior]
    C -->|J₃: Execution Jacobian| D[Programmer<br/>the operator]
    D -->|J₄: Tool Jacobian| E[Tools<br/>nonlinear contributors]
