...
```mermaid
flowchart TD
    A[Me<br/>trained human prior] -->|J₁: Human-to-Machine Jacobian| B[Machine<br/>trained model prior]
    B -->|J₂: Coupling Jacobian| C[Us<br/>the collaborative instrument]
    C -->|J₃: Execution Jacobian| D[Programmer<br/>the operator]
    D -->|J₄: Tool Jacobian| E[Tools<br/>externalized structure]
    E -->|J₅: Civilization Jacobian| F[Humanity<br/>the global manifold]
```
