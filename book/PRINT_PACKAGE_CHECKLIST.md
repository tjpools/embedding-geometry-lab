...
Use this as the final packaging sheet while finishing Scribus and preparing KDP upload.

Detailed type fitting rules live in `PRINT_COVER_TYPOGRAPHY_SPEC.md`.
...
If the front cover feels crowded, keep the title and emblem hierarchy intact first. Only then consider the short subtitle fallback.

## Barcode / Safe Area

- Leave barcode box clear: `2.000 x 1.200 in`
- Keep live text inside the established safe area
- Do not place subtitle on the spine
...
- Proof at 100%
- KDP preview checked before final upload