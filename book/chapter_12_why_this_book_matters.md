...
The claim of this book is not that intelligence has been solved. It is not that a machine has become human. It is not that language models should be worshipped or dismissed. The claim is narrower, harder, and more useful: that intelligence, representation, tool use, and collaboration become clearer when we recover their geometry.
...
That distinction matters. It is the difference between architecture and trained state, between source and runtime, between the operator and the geometry that results from repeated application of that operator.
...
The argument among Newton, Leibniz, and Berkeley did not end in the early modern period. It is still with us.

It appears whenever continuous mathematics is implemented through discrete procedure.
It appears whenever smooth theory meets finite precision.
It appears whenever an elegant operator must run on a circuit.
It appears whenever symbolic success is mistaken for metaphysical resolution.
...
The book offers the charts, transitions, orientation, and historical and philosophical structure. The repository offers measurements, scripts, artifacts, disassemblies, tests, and traces. One side makes the path legible. The other side makes it inspectable.
