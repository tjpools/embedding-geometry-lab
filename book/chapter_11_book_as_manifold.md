...
Chapter 10 argued that a cockpit teaches curvature by forcing the pilot to inhabit it. Chapter 11 makes the parallel claim about reading: a nonlinear digital book teaches structure by forcing the reader to navigate it.
...
That distinction matters because the collaboration has already been validated locally in conversations and revisions. A book is the global test: whether those local regions of understanding can be integrated into one traversable object whose structure holds at scale.
...
Traversal is a form of agency. A reader does not merely receive meaning; the reader enacts it.
...
The ebook permits a form that better matches the thesis. It lets the work behave more like the object it is trying to describe: a structured field of possible traversals rather than a single forced route.

That parallel becomes clearer in light of what a transformer is. A transformer moves through a learned field of distinctions, preserving, reshaping, and continuing meaning under constraint. A reader moves through a structured book by analogous means: entering through one region, carrying relations forward, and reinterpreting earlier parts in light of later ones. The analogy should stay disciplined. A book is not a model, and a model is not a person. But both can be understood as path-dependent systems in which meaning emerges through motion across organized relations.

The asymmetry still matters. The transformer traverses the field it is given. The human chooses, interprets, and reshapes the field under consideration. That is why the ebook belongs to the argument. It is not just a vessel for claims about structured intelligence. It is one of the public interfaces through which structured traversal becomes experience.
...
That recognition matters because the subject of this manuscript is not AI in isolation. It is the geometry through which AI becomes intelligible to a human reader. The book is therefore part of the proof. Its form cannot be wholly separate from its claim. To write the book is to ask whether locally established understanding can become globally coherent.
