...
The author is no longer just the human or the machine considered separately. In work like EasterDate, where direction, implementation, correction, and restructuring pass back and forth, the author is better described as the coupled system operating in a stable region of the manifold.
