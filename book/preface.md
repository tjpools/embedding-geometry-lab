...
To understand the configurations is to understand the domain.

A predicate may remain stable in mental space while the geometry required to execute it changes completely across tools.
